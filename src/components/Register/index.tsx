  ...
  return (
      ...
      <div className="w-[600px] bg-[#FFF] rounded-lg h-auto px-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col">
            ...
            <input className={`border w-full border-gray-200 py-2 pl-2 rounded-md
    ...
    `}>
        ...
        `}
                ...
                {...register("confirmPassword")} // Sử dụng trường "confirmPassword" cho ô nhập xác nhận mật khẩu
              />
            ...
            <span className="mb-2 text-red-500">{errors.confirmPassword?.message}</span> {/* Sử dụng errors.confirmPassword để hiển thị lỗi */}
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          <div className="flex flex-col">
            ...
            <div className="relative w-full">
              <input
                className={`border w-full border-gray-200 py-2 pl-4 pr-10 rounded-md ${errors.email ? 'border-red-300' : 'border-gray-200'} `} type="text" placeholder="DD/MM/YYYY"   {...register('birthday')}
              />
